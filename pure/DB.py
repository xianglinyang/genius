...
class DB:
    ...
    def __init__(self, feature_size=8, nearest_neighbours=1000):
    ...
    def append_to_DB(self, fvector, func_name="", firmware_name=""):
        if fvector is None:
            return
        self.engine.store_vector(np.asarray(fvector), ".".join((firmware_name, func_name)))

    def batch_append_to_DB(self, features, firmware_name=""):
        # TODO
        pass
